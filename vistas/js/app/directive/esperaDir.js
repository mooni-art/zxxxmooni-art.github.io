...
'use strict'
    ...
    "<div class='row' ><div class='col-12' style='text-align: center; align-content: center;' >"+
  	"<span><img class='spiner mr-4' src='./vistas/img/lunaAzul.png' style='height: 50px;width : 50px;'></span>"+
    "<span><img src='./vistas/img/logomooniaart.png' style='width : 150px;'></span></div></div></div></div></div>"
		};
	}]);
})();
